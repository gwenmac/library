...
INSERT INTO wishlist_book(title, notes, sort_title, user_id, release_date, created_at, updated_at) VALUES
   ('The Hobbit', 'Prequel to Lord of the Rings.', 'Hobbit', 1, NOW(), NOW(), NOW()),
   ('Neuromancer', 'Classic cyberpunk novel by William Gibson. Heard great things about it.', 'Neuromancer',1, NOW(), NOW(), NOW());

INSERT INTO wishlist_book_author(wishlist_book_id, author_id) VALUES
